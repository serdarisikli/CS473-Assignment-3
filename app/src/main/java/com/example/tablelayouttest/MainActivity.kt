    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_add.setOnClickListener {
            if(!et_androidVersion.text.toString().equals("") && !et_codeName.text.toString().equals(""))
                ...
                Toast.makeText(applicationContext, "Please fill mandatory fields", Toast.LENGTH_SHORT).show()
            }
        }
        ...
        tr = findViewById(R.id.tableRow_2)
        tv = findViewById(R.id.tvTmp)
    }
    fun addNewRow(){
        ...
        tv1.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15.0f);

        tv2.layoutParams = tv.layoutParams
        tv2.setText(et_codeName.text.toString())
        tv2.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15.0f);
